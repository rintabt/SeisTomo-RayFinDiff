function TT_ZX = eikonal2D_edited(model,temp,Pilih)
...
if Pilih.I ~= 2
    V_ZX = model.V;
else %Pilih.I == 2 %Mendapatkan d_kal
    V_ZX = model.V0;
end
...
CloseMask_ZXY = CloseMask_ZXY & BoundMask_ZXY; % sel yang sudah ada T nya, tapi sekelilingnya belum ada
...
%         display(['calculated points : ' num2str(calccount)])
    end
end
