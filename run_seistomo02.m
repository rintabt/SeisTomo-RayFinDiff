...
Pilih.IF = 2;   % 1=Inversi ; 2=Forward
Pilih.display_log = 0;
...
Model.NamaSave = 'k_5_35-37_23-27';

[Model,Eq] = ModelAwal(Model, 5000, 5000,N); 
% Model.V0 = flip(Model.V0);

Model.V0 = 500*ones(Model.sz);
Model.V0(14:end,:)=5000;
Model.V0(35:37,23:27)=1500;

%     Model.V0 = Model.V;
%     Model.V0(Model.V0==500) = 600;
%     Model.V0(Model.V0==1000) = 900;
%     Model.V0(Model.V0==2000) = 1000;
%     Model.V0(Model.V0==3000) = 2000;
...
% Model.V0 = zeros(Model.sz);
% Model.V0(1:5,:) = 500;
% Model.V0(Model.V0==0) = 3000;

%     Model.V0 = Model.V0'; %Ini biar gradasi nya scr horizontal
...
%             suptitle (['Iterasi ke-' num2str(Temp.iter) '[Erms = ' num2str(Temp.E) '%]' '[konv = ' num2str(Temp.konv) ']'])
%             
%             pause(0.01)
%             if Pilih.SaveGambar == 1
%                 Temp.savenama = [Pilih.Tempat Model.NamaSave '_iter-' num2str(Temp.iter) ' [1].jpg'];
...
%             subplot('Position',[0.57,0.675,0.3278,0.1664]) %Plot d_obs&d_kal
...
%             subplot('Position',[0.57,0.05,0.3278,0.5])
%             Temp.selisih_m = Model.V-Model.V0;
%             imagesc(Temp.selisih_m),colorbar
%             title(['Selisih Velocity [Iterasi ke-' num2str(Temp.iter) ']'])
...
%     BerhentiDi = [Temp.iter Temp.E Temp.konv WaktuTotal];
%     save([Pilih.Tempat Model.NamaSave 'BerhentiDi.txt'],'BerhentiDi','-ascii')
